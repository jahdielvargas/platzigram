      ...
      <div class="row">
        ${user.pictures.map(function (picture) {
          return yo`<div class="col s12 m6 l4">
            <a href="#modal${picture.id}" class="picture-container modal-trigger">
            ...
            <div id="modal${picture.id}" class="modal modal-fixed-footer">
              ...
              <div class="modal-footer">
                <div class="btn-flat likes"><i class="fa fa-heart"></i>${translate.message('likes', {likes: picture.likes})}</div>
              </div>
            </div>
          </div>`
        })}
